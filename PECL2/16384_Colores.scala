object Pec
{
    ...
    def pintarTableroAux(lista: List[Int], columna: Int): Unit =
    {
        if (lista != Nil)
        {
            ...
            lista.head match
            {
                case 0 => print(Console.WHITE)
                case 2 => print(Console.YELLOW)
                case 4 => print(Console.RED)
                case 8 => print(Console.MAGENTA)
                case 16 => print(Console.CYAN)
                case 32 => print(Console.BLUE)
                case 64 => print(Console.YELLOW)
                case 128 => print(Console.RED)
                case 256 => print(Console.MAGENTA)
                case 512 => print(Console.CYAN)
                case 1024 => print(Console.BLUE)
                case _ => print(Console.YELLOW)
            }
            print(lista.head + Console.RESET)
